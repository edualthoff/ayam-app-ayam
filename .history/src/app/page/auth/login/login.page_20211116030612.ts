...
export class LoginPage implements OnInit {
  ...
  ionViewWillEnter() {
    console.log("routa log "+this.activedRoute.params['email'])
    console.log("routa log "+this.activedRoute.snapshot.params['email'])

    if(this.activedRoute.snapshot.params['email'] == undefined || this.loginError == true) {
      console.log("routa log3 "+this.activedRoute.snapshot.params['email'])
