...
export class ProdutoRequestService {
  ...
  findParameterNameOrAll(nome = '', sort = 'asc', page = 0, size = 10): Observable<PaginationResponse<ProdutoDto>>  {
    ...
    return this.http.get<PaginationResponse<ProdutoDto>>('/produto', { params: params2 });
  }
