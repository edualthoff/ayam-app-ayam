...
export class InformativoRequestService {
  ...
  findParameterNameOrAll(nome = '', sort = 'asc', page = 0, size = 10): Observable<PaginationResponse<Informativo>>  {
  ...
  findAllByTipoAndAtivo(infoTipo: string): Observable<Array<Informativo>> {
    return this.http.get<Array<Informativo>>(`/informativo/${infoTipo}/destaque/ativo`);
  }
