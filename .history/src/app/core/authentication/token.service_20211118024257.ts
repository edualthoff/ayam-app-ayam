...
import { Token, TokenResponse, TokenJwt } from './interface';
...
export class TokenService {
  ...
  private _token: TokenJwt | null = null;
  private _tokenRefresh: TokenJwt | null = null;
  ...
  private getToken(): TokenJwt | null {
    if (!this.hasToken()) {
      return null;
    }
  ...
  private getRefreshToken(): TokenJwt | null {
