...
export class AuthService {
  ...
  private _state: ActivatedRouteSnapshot = null;
  set state(router: ActivatedRouteSnapshot) {
    this._router = router;
  }
