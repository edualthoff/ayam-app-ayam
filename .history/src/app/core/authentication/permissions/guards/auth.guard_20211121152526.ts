...
export class AuthGuard implements CanActivate, CanActivateChild {
  ...
  private transformPermission(permissions: PermissionsRouterData, route: ActivatedRouteSnapshot | Route,
    ...
    const only = permissions.only != undefined ? transformStringToArray(permissions.only) : '' ;
    const except = permissions.except != undefined ? transformStringToArray(permissions.except) : '';
