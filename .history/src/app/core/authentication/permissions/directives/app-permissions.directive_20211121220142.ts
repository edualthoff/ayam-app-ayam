...
export class AppPermissionsDirective implements OnInit, OnChanges {
  ...
  ngOnChanges(changes: SimpleChanges): void {
    ...
    if (onlyChanges || exceptChanges) {
      ...
      console.log("ngOnChanges "+this.appPermissionsExcept +" "+this.appPermissionsOnly)
  ...
  private validateExceptOnlyPermissions(): Subscription {
    console.log("validateExceptOnlyPermissions "+this.appPermissionsExcept +" "+this.appPermissionsOnly)
