...
import { ChangeDetectorRef, Directive, Inject, Input, OnChanges, OnInit, Optional, SimpleChanges, TemplateRef, ViewContainerRef } from '@angular/core';
...
export class AppPermissionsDirective implements OnInit, OnChanges {
  ...
  appPermissions: TemplateRef<any>;
  ...
  constructor(private viewContainer: ViewContainerRef, private changeDetector: ChangeDetectorRef,
    @Optional() private templateRef: TemplateRef<any>, private rolesService: AppRolesService) {
